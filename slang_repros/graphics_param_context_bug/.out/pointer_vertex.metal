...
{
    float2 device* device* entryPointParams_params_positions_0;
};
...
VSOut_0 VertexMain_0(const VSIn_0 thread* input_0, KernelContext_0 thread* kernelContext_0)
{
    ...
    (&o_0)->pos_0 = float4((*kernelContext_0->entryPointParams_params_positions_0)[(*input_0).vertex_id_0], 0.0, 1.0);
    return o_0;
}
